...
REGRESS = datatype external mapping retrieval date_comparison ldap_authentication remote_estimates log_remote_sql where_push_down misc where_push_down_normal_queries auth_client_type_parameters join_pushdown aggregate_pushdown
EXTENSION = hdfs_fdw
